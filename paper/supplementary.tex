...
\caption{Implementation detail of Phases 5--11: the non-graph MMoEEx baseline (Phase 5) and the graph-routed joint multitask training (Phase 7) shown in Figure~\ref{fig:process_flow} share the same DataLoader, initialization, and epoch training loop, differing only in whether the graph router contributes to expert routing; downstream phases (LLM ablations, domain adaptation, calibration, explainability) follow.}
