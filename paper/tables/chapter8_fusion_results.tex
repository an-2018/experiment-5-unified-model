\begin{table}[htbp]
\centering
\caption{Fusion Ablation Results. Best fusion method per dataset in bold. Cross-attention fails on all three datasets (see Section~\ref{sec:fusion_ablation} for discussion). Numbers in parentheses show change vs best unimodal baseline. Source: \texttt{artifacts/tables/fusion\_baselines.csv}.}
