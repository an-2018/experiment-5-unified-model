...
Figure~\ref{fig:process_flow_main} gives an overview of the full experimental pipeline, from data and feature extraction through the baseline ladder, the graph-routing investigation, and the downstream LLM, calibration, domain-adaptation, and explainability analyses; a further figure detailing the implementation of Phase 7 joint multitask training itself is in the supplementary material.
