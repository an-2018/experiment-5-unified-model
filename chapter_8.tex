...
\begin{enumerate}
    ...
    \item \textbf{LLM encoders improve all tasks over classical encoders}, but no LLM level (L1--L5) surpasses graph routing. L3 (Mistral+CLAP, DAIC AUROC=0.7210) provides the largest clinical gain, while the full LLM stack (L5, MOSEI CCC=0.6284) provides the best sentiment performance.
