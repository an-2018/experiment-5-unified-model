...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{paper/figures/training_pipeline.png}
    \caption{Implementation detail of Phase 7 joint multitask training, including the phase that precedes it (Phase 5, the non-graph MMoEEx baseline used as the comparison point throughout Section~\ref{sec:graph_results}). The graph router (bottom right) is used only for the graph-routed V0--V4 variants; Phase 5 uses the task gate alone.}
